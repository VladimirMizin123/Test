...
//
//     final searchAddressResponseModel = searchAddressResponseModelFromJson(jsonString);

import 'dart:convert';

SearchAddressResponseModel searchAddressResponseModelFromJson(String str) =>
    SearchAddressResponseModel.fromJson(json.decode(str));

String searchAddressResponseModelToJson(SearchAddressResponseModel data) =>
...
class SearchAddressResponseModel {
  ...
  factory SearchAddressResponseModel.fromJson(Map<String, dynamic> json) =>
      SearchAddressResponseModel(
