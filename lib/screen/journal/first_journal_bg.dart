...
class FirstJournalBGView extends StatelessWidget {
  const FirstJournalBGView({super.key});

  final routeName = '/FirstJournalBGView';
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage(AssetsUtils.journalBG1),
            fit: BoxFit.fill,
          ),
        ),
        child: Column(
