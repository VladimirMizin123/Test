                    ...
                    Expanded(
                      child: getAddressLoadingState == true
                          ...
                          : Builder(builder: (context) {
                              return getRestaurantMenuLoadingState == true ||
                                      getCousinesLoadingState == true
                                                          ...
                                                          result.isEmpty
                                                              ...
                                                              : Get.to(
                                                                  () =>
                                                                    ...
                                                                    getUserAddress:
                                                                        getUserAddress,
                                                                    address: searchRestaurantList
                                                                        .elementAt(
                                                                            index)
                                                                        .address!,
                                                                    userId: searchRestaurantList
                                                                            .elementAt(index)
                                                                            .id ??
                                                                        "",
                                                                    restaurantName:
                                                                ...
                                                                child: Column(
                                                                  crossAxisAlignment:
                                                                      CrossAxisAlignment
                                                                          .start,
                                                                  children: [
                                                                    searchRestaurantList.elementAt(index).quotes?.cheapestDelivery?.deliveryFee?.deliveryFeeFlat ==
                                                                            0
                                                                        ? Container(
                                                                            width:
                                                                                109,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          searchRestaurantList.elementAt(index).cuisines!.isEmpty || searchRestaurantList.elementAt(index).cuisines == []
                                                                              ? ''
                                                                              : searchRestaurantList.elementAt(index).cuisines![0],
                                                                          style:
                                                                              FontUtils.h14(
                                                                            fontColor:
                                                                                AppColors.darkGray,
                                                                  ...
                                                                  : Get.to(
                                                                      () =>
                                                                        ...
                                                                        address: restaurantList
                                                                            ...
                                                                            .address!,
                                                                        userId:
                                                                            restaurantList.elementAt(index).id ??
                                                                                "",
                                                                        restaurantName:
                                                                ...
                                                                child: Column(
                                                                  crossAxisAlignment:
                                                                      CrossAxisAlignment
                                                                          .start,
                                                                  children: [
                                                                    restaurantList.elementAt(index).quotes?.cheapestDelivery?.deliveryFee?.deliveryFeeFlat ==
                                                                            0
                                                                        ? Container(
                                                                            width:
                                                                                109,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          restaurantList.elementAt(index).cuisines!.isEmpty || restaurantList.elementAt(index).cuisines == []
                                                                              ? ''
