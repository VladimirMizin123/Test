  ...
  Widget build(BuildContext context) {
    ...
    carouselList = [
      Row(
        ...
        children: [
          commonSliderView(icon: AssetsUtils.breakFastIcon, title: StringUtils.breakfast, textTheme: Theme.of(context).textTheme, context: context),
          commonSliderView(icon: AssetsUtils.lunchIcon, title: StringUtils.lunch, textTheme: Theme.of(context).textTheme, context: context),
        ],
      ),
      Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          commonSliderView(icon: AssetsUtils.snackIcon, title: StringUtils.snack, textTheme: Theme.of(context).textTheme, context: context),
          commonSliderView(icon: AssetsUtils.dinnerIcon, title: StringUtils.dinner, textTheme: Theme.of(context).textTheme, context: context),
        ],
      ),
    ];
                ...
                child: BlocConsumer(
                  ...
                  listener: (context, state) async {
                    if (state is LoadDashboardData) {
                      ...
                      await PreferenceUtils.setString(totalCalorie, model.data!.totalCalorie.toString());
                      await PreferenceUtils.setString(totalProtein, model.data!.totalProtein.toString());
                      await PreferenceUtils.setString(totalFat, model.data!.totalFat.toString());
                      await PreferenceUtils.setString(totalCarbs, model.data!.totalCarbs.toString());
                            ...
                            calDataView(
                              ...
                              calCount: /*int.parse(model.data!.totalIntakeFood!
                                  ...
                                  ? model.data!.totalIntakeFood!
                                      ...
                                      .toString()
                                  :*/
                                  model.data!.totalIntakeFood!.toDouble().floor().toString(),
                            ...
                            calDataView(
                              ...
                              calCount: /*int.parse(model
                                  ...
                                  ? model.data!.totalBurnedByExercise!
                                      ...
                                      .toString()
                                  :*/
                                  model.data!.totalBurnedByExercise!.toDouble().floor().toString(),
                              textTheme: Theme.of(context).textTheme,
                            ),
                          ],
                      ...
                      calciumDataView(
                        ...
                        gramCount: /*int.parse(model.data!.totalIntakeCarbs!
                            ...
                            ? model.data!.totalIntakeCarbs!
                                ...
                                .toString()
                            :*/
                            model.data!.totalIntakeCarbs!.toDouble().floor().toString(),
                      ...
                      calciumDataView(
                          ...
                          gramCount: /*int.parse(model.data!.totalIntakeProtein!
                              ...
                              ? model.data!.totalIntakeProtein!
                                  ...
                                  .toString()
                              :*/
                              model.data!.totalIntakeProtein!.toDouble().floor().toString(),
                          totalGram: /*int.parse(model.data!.totalProtein!
                              ...
                              ? model.data!.totalProtein!
                                  ...
                                  .toString()
                              :*/
                              model.data!.totalProtein!.toDouble().floor().toString(),
                      ...
                      calciumDataView(
                        ...
                        gramCount: /*int.parse(model.data!.totalIntakeFat!
                            ...
                            ? model.data!.totalIntakeFat!
                                ...
                                .toString()
                            :*/
                            model.data!.totalIntakeFat!.toDouble().floor().toString(),
            ...
            Row(
              ...
              children: [
                  ...
                  child: InkWell(
                    ...
                    child: dashBoardCardView(
                      ...
                      child: waterExerciseDataView(
                        percentage: model.data!.totalIntakeWater! / model.data!.dailyWaterGoals!,
                ...
                Expanded(
                  child: InkWell(
                    onTap: () {
                      Get.toNamed('/AddExerciseScreen', arguments: AddExerciseArguments(dateTime: DateTime.now()))!.then((value) {
                        bloc.add(GetDashboardData());
                      });
                    ...
                    child: dashBoardCardView(
                      ...
                      child: waterExerciseDataView(
                        percentage: model.data!.totalBurnedByExercise! / model.data!.dailyExerciseGoals!,
                          ...
                          : () {
                              if (!trackerDataList[index].isDone) {
                                bloc.add(AddEatenMealData(
                                    ...
                                    calorie: trackerDataList[index].recipe!.nutrientsPerServing!.calories,
                                    carbs: trackerDataList[index].recipe!.nutrientsPerServing!.carbs,
                                    fat: trackerDataList[index].recipe!.nutrientsPerServing!.fat,
                                    protein: trackerDataList[index].recipe!.nutrientsPerServing!.protein,
                      ...
                      child: isDoneLoader && trackerDataList[index].id == mealId
                          ...
                          : Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: isEaten ? AppColors.primaryBlue : AppColors.skyBlue,
                              ),
                              child: Center(
                                child: Icon(
                                  isEaten ? Icons.check : Icons.add,
                                  color: isEaten ? Colors.white : AppColors.primaryBlue,
                                ),
                              ),
                            ),
                    ),
