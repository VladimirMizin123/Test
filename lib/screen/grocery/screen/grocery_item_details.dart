  ...
  void initState() {
    ...
    if (widget.arguments!.isFromGroceryScreen == true) {
      ...
      if (widget.arguments!.isFromCustomMealScreen == true) {
        log("MEAL INFO isFromCustomMealScreen");
        log((widget.arguments?.productName ?? 0).toString());
        log((widget.arguments?.quantity ?? 0).toString());
        log((widget.arguments?.cal ?? 0).toString());
        log((widget.arguments?.fat ?? 0).toString());
        log((widget.arguments?.carbs ?? 0).toString());
        log((widget.arguments?.protein ?? 0).toString());
              ...
              child: SafeArea(
                child: Column(
                  children: [
                    ...
                    Expanded(
                        child: widget.arguments!.isFromCustomMealScreen
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          //         1
                                          //     ?
                                          if (widget.arguments?.isShowData !=
                                              true)
                                            GestureDetector(
                                              onTap: () {
                                                if (productCount != 1) {
                                        ...
                                        children: [
                                          Text('Calories',
                                              style: FontUtils.h16(
                                                  ...
                                                  fontWeight: FWT.medium)),
                                          Text(
                                              '${(widget.arguments?.cal ?? 0.00).toStringAsFixed(2)} cal',
                                              style: FontUtils.h16(
                                                  fontColor: AppColors.darkGray,
                                                  fontWeight: FWT.medium)),
                                        ],
                                        ...
                                        children: [
                                          Text('Fat',
                                              style: FontUtils.h16(
                                                  ...
                                                  fontWeight: FWT.medium)),
                                          Text(
                                              '${((widget.arguments?.fat ?? 0.00)).toStringAsFixed(2)}g',
                            ...
                            : nutritionixGetNxMealInfoByNameModelData == null
                                ...
                                : BlocConsumer(
                                    ...
                                    listener: (context, state) {
                                      ...
                                      ///----------Loading State
                                      if (state
                                          is UpdateAddGroceryListLoadingState) {
                                        add = true;
                                      }

                                      ///----------Error State
                                      if (state
                                          is UpdateAddGroceryListErrorState) {
                                        add = false;
                                      }

                                      ///----------Success State
                                      if (state
                                          is UpdateAddGroceryListSuccessState) {
                                        add = false;
                                        productCount = productCount + 1;
                                        widget.arguments!.groceryShoppingData!
                                            .quantity = widget.arguments!
                                      ...
                                      ///----------Loading State
                                      if (state
                                          is RemoveGroceryItemLoadingState) {
                                        delete = true;
                                      }

                                      ///----------Success State
                                      if (state
                                          is RemoveGroceryItemSuccessState) {
                                        delete = false;
                                        Get.back();
                                      }
                                      ...
                                      ///----------Error State
                                      if (state
                                          is RemoveGroceryItemErrorState) {
                                        delete = false;
                                      }
                                                                    ...
                                                                    addNewGroceryItemBloc
                                                                      ...
                                                                      UpdateRemoveNewGroceryItem(
                                                                        ...
                                                                        itemName: widget
                                                                            ...
                                                                            .toString(),
                                                                        quantity:
                                                                            widget.arguments!.groceryShoppingData!.quantity -
                                                                                1,
                                                                        measurementType: widget
                                                                            .arguments!
                                                                            .groceryShoppingData!
                                                                ...
                                                                ? Container(
                                                                    ...
                                                                    padding: const EdgeInsets
                                                                        ...
                                                                        horizontal:
                                                                            16),
                                                                    child: Text(
                                                                      widget.arguments?.groceryShoppingData?.measurementType == null ||
