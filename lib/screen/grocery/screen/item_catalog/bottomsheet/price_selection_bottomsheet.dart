...
class PriceSelectionBottomSheet extends StatefulWidget {
  const PriceSelectionBottomSheet({super.key});

  @override
  State<PriceSelectionBottomSheet> createState() => _PriceSelectionBottomSheetState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                  ...
                  child: Row(
                    children: [
                      Text('Price', style: FontUtils.h22(fontColor: AppColors.darkGray, fontWeight: FWT.semiBold)),
                    ],
                  )),
              ...
              Row(
                ...
                children: [
                  Text('min ${_currentRangeValues.start}', style: FontUtils.h14(fontColor: AppColors.darkGray)),
                  Text('max ${_currentRangeValues.end}', style: FontUtils.h14(fontColor: AppColors.darkGray)),
                ],
              ),
