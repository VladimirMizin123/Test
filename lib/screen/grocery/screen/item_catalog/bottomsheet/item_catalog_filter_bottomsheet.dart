...
class ItemCatalogFilterBottomSheet extends StatefulWidget {
  const ItemCatalogFilterBottomSheet({super.key});
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Row(
              children: [Text(title, style: FontUtils.h16(fontColor: AppColors.black)), const Spacer(), Text(subTitle, style: FontUtils.h16(fontColor: AppColors.black)), const SizedBox(width: 10), trailingWidget],
            ),
