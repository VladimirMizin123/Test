...
class ItemCatalogFilterBottomSheet extends StatefulWidget {
  const ItemCatalogFilterBottomSheet({
    super.key,
    this.value,
    this.onShowItem,
  });
  final RangeValues? value;
  final Function(Map<String, dynamic>)? onShowItem;
  @override
        ...
        Row(
          children: [
            Text(
              'Filters',
              style: FontUtils.h22(
                  fontColor: AppColors.darkGray, fontWeight: FWT.semiBold),
            ),
            10.width,
            Container(
              height: 22,
