...
class _ItemCatalogScreenState extends State<ItemCatalogScreen> {
  ...
  fillData() {
    ...
    groceryTempResult = (jsonDecode(jsonEncode(groceryResult)) as List)
                ...
                children: [
                  SizedBox(
                    ...
                    child: BackButtonWidget(
                      onTap: () {
                        for (int i = 0; i < groceryTempResult.length; i++) {
                          groceryResult[i].isAddedToShoppingList =
                              groceryTempResult[i].isAddedToShoppingList;
                          groceryResult[i].cartItemCount =
                              groceryTempResult[i].cartItemCount;
                        }
                        Get.back();
                      },
                    ),
