...
class RestaurantSearchModel {
  ...
  final RestaurantSearchData? data;
  ...
  factory RestaurantSearchModel.fromJson(Map<String, dynamic> json) => RestaurantSearchModel(
        ...
        data: json["data"] == null ? null : RestaurantSearchData.fromJson(json["data"]),
      );
...
class RestaurantSearchData {
  ...
  factory RestaurantSearchData.fromJson(Map<String, dynamic> json) => RestaurantSearchData(
        products: json["products"] == null ? [] : List<RestaurantProduct>.from(json["products"]!.map((x) => RestaurantProduct.fromJson(x))),
      );
...
class RestaurantProduct {
  ...
  factory RestaurantProduct.fromJson(Map<String, dynamic> json) => RestaurantProduct(
